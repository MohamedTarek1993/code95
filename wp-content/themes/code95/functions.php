...
function code95_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'code95' ),
		)
	);
...
function code95_scripts() {
	wp_enqueue_style( 'code95-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'code95-style', 'rtl', 'replace' );

	wp_enqueue_script( 'code95-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
